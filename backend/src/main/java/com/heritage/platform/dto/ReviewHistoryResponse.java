...
public class ReviewHistoryResponse {
    private UUID id;                  // Evaluation record unique ID, randomly generated in the background.
    private UUID resourceId;          
    private String resourceTitle;     
    private String reviewerName;      // Reviewer's name (replaces the Employee ID you mentioned)
